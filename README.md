...
After the Modbus devices has been configured, it is auto-discovered as thing. If the Modbus has connection to i.e. Thermostats etc. they in addition will be discovered as separate 'things'
