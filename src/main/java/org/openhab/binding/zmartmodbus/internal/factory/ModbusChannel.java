...
import org.openhab.binding.zmartmodbus.ZmartModbusBindingClass.ModbusDataType;
...
public class ModbusChannel {
    ...
    public ModbusChannel(int nodeId, ChannelUID uid, String dataSetKey, ModbusValueClass valueClass, int index,
