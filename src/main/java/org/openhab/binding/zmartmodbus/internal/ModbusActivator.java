...
/**
 * Bundle activator to register the modbus service providers
 *
 * @author Chris Jackson
 * @author Peter Kristensen - modified for Zmartify ModbusFunction
 */
public final class ModbusActivator implements BundleActivator {
    ...
    public void start(BundleContext bc) throws Exception {
        context = bc;
        logger.debug("Zmartify ModbusFunction binding started. Version {}", ModbusActivator.getVersion());
    }
    ...
    public void stop(BundleContext bc) throws Exception {
        context = null;
        logger.debug("Zmartify ModbusFunction binding stopped.");
    }
