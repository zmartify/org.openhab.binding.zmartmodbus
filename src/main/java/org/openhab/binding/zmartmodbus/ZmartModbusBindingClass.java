 ...
 *
 */
public class ZmartModbusBindingClass {

    /**
     *
     */
    private ZmartModbusBindingClass() {
    };
    ...
    public static enum ModbusNodeClass {
        ...
        JablotronActuator(THING_TYPE_JABLOTRON_ACTUATOR, ModbusFunctionJablotron.class, false), // Jablotron actuator
        JablotronTP150(THING_TYPE_JABLOTRON_TP150, ModbusFunctionJablotron.class, false), // Jablotron thermostat
        JablotronAC116(THING_TYPE_JABLOTRON_AC116, ModbusFunctionJablotron.class, true), // Jablotron Modbus slave
        Nilan(THING_TYPE_NILAN_COMFORT_300, ModbusFunction.class, false), // Nilan Modbus slave
